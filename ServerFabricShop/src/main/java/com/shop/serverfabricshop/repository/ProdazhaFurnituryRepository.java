 ...
 */
@Repository
public interface ProdazhaFurnituryRepository extends CrudRepository<Prodazhafurnitury, Integer> {

    List<Prodazhafurnitury> findByIdFurnituraId(Integer furnituraId);
