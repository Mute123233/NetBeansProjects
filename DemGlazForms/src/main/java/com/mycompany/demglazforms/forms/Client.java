...
public class Client extends javax.swing.JFrame {
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        setTitle("Панель клиента - " + fio.trim());
                    });
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ООО «Обувь» - Клиент");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 1346, javax.swing.GroupLayout.PREFERRED_SIZE)
